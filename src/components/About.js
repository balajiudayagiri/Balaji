...
const About = () => {
  ...
  return (
    <div className={`text-gray-400  flex flex-col gap-3`}>
      <div className="flex flex-col-reverse gap-5 items-center justify-center md:flex-row mb-10">
        <div className="w-full lg:w-1/2 relative">
          <h1
            className={`text-4xl font-bold tracking-tight sm:text-5xl ${
              darkMode ? "dark:text-zinc-100" : "text-zinc-800"
            } mb-8 md:text-5xl`}>
        ...
        <div className="ld:p-[100px] md:p-[50px] sm:p-[100px] p-[50px]">
          <img
            src={myPic}
            className={
              "p-10 w-full object-cover lg:object-center rounded-3xl bg-zinc-900 rotate-[10deg]"
            }
      ...
      <p
        className={`sm:w-full p-4 rounded-lg mb-5 border-solid border-2 border-zinc-700 ${
          darkMode ? "dark:bg-zinc-900" : "light:bg-zinc-800"
        }`}>
      ...
      <h3
        className={`text-3xl font-bold tracking-tight my-4 sm:text-5xl ${
          darkMode ? "dark:text-zinc-200" : "text-zinc-200"
        }`}>
        The Tech Toolbox
      </h3>
      ...
      <footer
        className={`text-gray-600 p-20 text-center text-sm ${
